...
# 🤖 Proposta com mais ampliação de serviços gerenciados: AWS Ampliy para o Front
...
flowchart TD
    ...
    style N fill:#ffebee,stroke:#d32f2f,stroke-width2px
```
...
3.  **Deploy em Produção:** Após a aprovação do PR e merge na branch principal (ex.: `main`), o Amplify faz o deploy automático em produção.
